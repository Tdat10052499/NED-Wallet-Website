...
export const HowItWorks: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="scroll-mt-16 relative w-full bg-brand-deepPurple text-brand-offWhite py-20 sm:py-28 px-4 sm:px-6 lg:px-8 border-b-4 border-brand-inkBlack">
      <div className="max-w-7xl mx-auto">
        ...
        {/* 3 Step Cards with Staggered Entrance */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {/* Step 1 */}
          <RevealOnScroll animation="fade-up" delay={0} className="h-full">
            <div className="h-full relative bg-brand-darkSurface border-3 border-brand-inkBlack rounded-3xl p-7 flex flex-col justify-between shadow-brutal card-brutal-interactive">
            <div>
